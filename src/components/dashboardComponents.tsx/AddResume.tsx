...
const CreateResumeModal = ({callback}:{callback:React.Dispatch<SetStateAction<boolean>>} ) => {
  ...
  return (
    <div className="px-6 py-2" >
      ...
      >
        ...
        {
            createResume && <CreateResumeModal callback={setCreateResume} />
        }      
    </div>
  );
};
